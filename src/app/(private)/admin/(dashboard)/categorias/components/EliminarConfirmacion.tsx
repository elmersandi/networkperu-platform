...
export default function EliminarConfirmacion({ nombre, identificador, onConfirmar, onCancelar }: Props) {
  return (
    <div className="max-w-lg mx-auto bg-white rounded-xl border border-slate-300 p-6 text-center shadow-sm">
      ...
      <h2 className="text-lg font-semibold text-slate-800 mb-2">¿Eliminar categoría?</h2>
      <p className="text-sm text-slate-500 mb-1">
        Vas a eliminar <strong className="text-slate-700">{nombre}</strong>
      </p>
      <p className="text-xs text-slate-400 font-mono mb-6">Slug: {identificador}</p>
