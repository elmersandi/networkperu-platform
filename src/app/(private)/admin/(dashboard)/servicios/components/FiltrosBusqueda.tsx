...
function CustomSelect({ value, onChange, options, disabled = false, className = "" }: CustomSelectProps) {
  ...
  return (
    <div ref={containerRef} className={`relative w-full ${className}`}>
      ...
      {/* Menú flotante siempre blanco y estilizado */}
      {isOpen && !disabled && (
...
export default function FiltrosServicios({
  ...
  // Mapear opciones para CustomSelect
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
      ...
      <div className="relative w-full col-span-2 lg:col-span-1">
        ...
        <input
          type="text"
          placeholder="Buscar servicio, SKU..."
          value={busqueda}
