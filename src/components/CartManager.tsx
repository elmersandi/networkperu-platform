...
import { ShoppingCart, X, Minus, Plus, MessageCircle, Image as ImageIcon, CheckCircle2 } from "lucide-react";
...
function DrawerUnificado() {
  const { isCartOpen, setIsCartOpen, carrito, setCarrito, totalItems } = useCart();
          ...
          {pasoCheckout === "carrito" ? (
            ...
            <div className="flex gap-3">
              ...
              <button
                form="checkout-form"
                type="submit"
                className="flex-1 bg-[#25D366] text-white text-sm font-bold py-3 rounded-xl hover:bg-[#20bd5a] flex items-center justify-center gap-2 cursor-pointer"
              >
